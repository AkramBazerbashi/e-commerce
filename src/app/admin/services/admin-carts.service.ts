...
export class AdminCartsService {
  db :any;
  adminCarts: AdminCarts[] = [{date: "", userId: 0, cartsId: 0, products: [{cartsId: 0, productId: 0, quantity: 0}, ]}];
  ...
  async getAllCarts(){
    ...
    querySnapshot.forEach((doc) => {
      this.adminCarts[i] = {date: "", cartsId: 0, userId:0, products: [{cartsId: 0, productId: 0, quantity: 0}, ]};
